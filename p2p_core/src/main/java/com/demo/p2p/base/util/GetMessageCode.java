...
public class GetMessageCode {
	...
	private static final String ACCOUNT_SID = "e42f9ed5b78b443f9fc28d48c0764cdb";
	private static final String AUTH_TOKEN = "68690fc9e2f748b19006f2ae6917a562";

	/**
	 * @Title: getCode
	 * @Description: TODO(根据相应的手机号发送验证码)
	 * @param: @param phone
	 * @param: @return
	 * @return: String
	 * @throws:
