...
public class SendmailUtil {
    ...
    public static void sendMail(String receiveMailAccount,String mailContent,String username) throws Exception {
        ...
        */
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(myEmailAccount, "ELOAN", "UTF-8"));
...
/*	public static void main(String[] args) {
		String email = "583165647@qq.com";
		StringBuilder content = new StringBuilder(100).append("点击<a href='").append("http://localhost:8889/")
				.append("bindEmail.do?uuid=").append("uuid").append("'>这里</a>完成邮箱绑定，有效期")
